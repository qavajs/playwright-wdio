 ...
 */
When('I add headers to {value}:', async function (this: QavajsPlaywrightWdioWorld, requestKey: MemoryValue, headersDataTable: DataTable) {
 ...
 * """
 */
When('I add body to {value}:', async function (this: QavajsPlaywrightWdioWorld, requestKey: MemoryValue, body: string) {
    const request = await requestKey.value();
 ...
 */
When('I add form data body to {value}:', async function (this: QavajsPlaywrightWdioWorld, requestKey: MemoryValue, dataTable: DataTable) {
    const request = await requestKey.value();
 ...
 */
When('I send {value} request and save response as {value}', async function (this: QavajsPlaywrightWdioWorld, requestKey: MemoryValue, responseKey: MemoryValue) {
    const request = await requestKey.value();
